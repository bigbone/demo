/**************************** WARNING **********************
 *			DO NOT modify the codes below this warning
 *
 *							v0.5.3
 *********************************************************/
//图床的sdk js版本。
~(function() {
    ...
    function getImgURL(pid, type, https) {
        var url;
    ...
    _WB.getImgLargeFileSize = getImgLargeFileSize;
    _WB.getImgGeometry = getImgGeometry;
    _WB.getImageFormat = getImageFormat;
    _WB.getImgURL = getImgURL;
    _WB.isValidPicID = isValidPicID;
})();